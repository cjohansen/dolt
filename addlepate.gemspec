...
Gem::Specification.new do |s|
  ...
  s.homepage    = "http://gitorious.org/gitorious/addlepate"
  s.summary     = %q{Addlepate serves git trees and syntax highlighted blobs}
  s.description = %q{Addlepate serves git trees and syntax highlighted blobs}

  s.rubyforge_project = "addlepate"
